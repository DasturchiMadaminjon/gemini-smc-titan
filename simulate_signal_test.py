...
def run_test():
    ...
    # 1. Config o'qish (Fayl joylashuvi to'g'irlangan)
    ...
    # 3. Indikatorni ishga tushirish (Test maqsadida sifati 50 qilingan signal)
    ...
    if sig:
        ...
        # Nega chiqmaganini tushunish uchun debug qismi:
